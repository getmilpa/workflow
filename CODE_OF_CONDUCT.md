...
**conduct@getmilpa.com**. This is a dedicated conduct-reporting channel, separate
from security vulnerability disclosure (see [SECURITY.md](SECURITY.md) for the
latter). All complaints will be reviewed and investigated promptly and fairly.
